          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                Experience 12 exclusive ski-in, ski-out chalets and alpine lodges in Aspen's most
                prestigious locations. From slope-side penthouses to secluded mountain cabins,
          ...
          <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t border-muted">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">12</span> Premium Chalets Available
              </span>
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">$850-$2,200</span> per night
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">4.9★</span> Guest satisfaction
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">Concierge</span> Services included
            </div>
          </div>
        </div>
      </div>
