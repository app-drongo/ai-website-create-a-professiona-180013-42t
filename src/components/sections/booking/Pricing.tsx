...
export default function Pricing() {
  const apartments = [
    ...
    },
    {
      ...
      amenities: [Car, Utensils, Wifi, Wind],
      cta: 'Book Now',
      popular: true,
      image: 'family-apt',
    },
    {
      ...
      amenities: [Coffee, Utensils, Wifi, Wind],
      cta: 'Book Now',
      popular: false,
      image: 'penthouse',
    },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Discover our handpicked collection of premium apartments. Each property is
            professionally managed and equipped with everything you need for an unforgettable stay.
          </p>
          ...
          {apartments.map((apartment, index) => (
            ...
            >
              ...
              <CardContent className="relative space-y-6">
                {/* Amenities Icons */}
                <div className="flex justify-center gap-4 pb-4 border-b border-border/50">
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            Contact us directly for monthly rates and corporate housing solutions. We offer special
            pricing for stays of 30 days or longer.
          </p>
