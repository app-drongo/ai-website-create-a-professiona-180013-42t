...
import { ArrowRight, MapPin, Users, Calendar, Shield } from 'lucide-react';

export default function Cta() {
  const stats = [
    { value: '6', label: 'Premium Apartments', icon: MapPin },
    { value: '98%', label: 'Guest Satisfaction', icon: Shield },
    { value: '500+', label: 'Happy Guests', icon: Users },
    { value: '24/7', label: 'Local Support', icon: Calendar },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                Your Perfect Stay Awaits in
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Our Local Apartments
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Experience authentic local living in our carefully curated collection of 6 premium
                apartments. Each property offers comfort, convenience, and the perfect home base for
                your travels.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured on leading travel platforms
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Reserve your apartment instantly with flexible cancellation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Personal recommendations and 24/7 local support
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Walking distance to attractions, dining, and transport
              </p>
            </div>
          </div>
        </div>
