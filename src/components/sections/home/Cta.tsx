...
export default function Cta() {
  const stats = [
    ...
    { value: '6', label: 'Premium Properties', icon: MapPin },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Experience the comfort of home with our carefully curated collection of premium
                apartments. Each property offers modern amenities and authentic local charm for your
                perfect getaway.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Book your stay and receive immediate confirmation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Centrally located apartments near attractions and transport
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Dedicated local hosts available throughout your stay
              </p>
            </div>
          </div>
        </div>
