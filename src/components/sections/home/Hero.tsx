        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-sm font-medium text-primary">
              <span className="inline-block h-2 w-2 rounded-full bg-primary"></span>6 Premium
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Discover our handpicked collection of fully furnished apartments in the heart of the
              city. Perfect for business travelers, weekend getaways, and extended stays.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="text-base">
                <MapPin className="mr-2 size-5" /> View Locations
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">5.2</span> nights
              </p>
            </div>
          </div>
        </div>
